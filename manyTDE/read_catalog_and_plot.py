...
from . import plot_utils## plot styling 
from . import analysis_functions## analysis functions from the paper 
...
def load_dicts():
    with open(we_are_here / "data/inferred_params/plateau_tdes.pkl", 'rb') as f:
        dp = pickle.load(f)    
    with open(we_are_here / "data/inferred_params/no_plateau_tdes.pkl", 'rb') as f:
        dn = pickle.load(f)    
    return dp, dn
