...
from . import read_catalog_and_plot
...
def load_greene_dicts():
    ...
    """
    with open(we_are_here / "data/dynamical/greene_sigmas.pkl", 'rb') as f:
        dgs = pickle.load(f)    
    with open(we_are_here / "data/dynamical/greene_galaxy_masses.pkl", 'rb') as f:
        dgg = pickle.load(f)    
    return dgs, dgg
